...
<!-- [Katy: Steph commented out because these indicators are no longer part of the "core" seven. May need to add some back in.]
...
<!-- Katy: Steph commented this out because we are no longer using relative benchmarks (right?) and the Nass-Skeena estuary (even-year) pink CU shows up under both Skeena and Nass in the new format.
#### Trans-regional Conservation Units {#nass-trans-CU}
...
The pink (odd-year) Homathko-Klinaklini-Smith-Rivers-Bella Coola-Dean CU spans the boundary between the Central Coast and Vancouver Island & Mainland Inlets Regions. <!-- Katy: Removed since we're not using relative benchmarks, right?

For habitat indicators that used relative benchmarks, habitat status for this trans-regional CU was assessed based on benchmarks derived from the Central Coast region because a significant portion of spawning habitat for this conservation unit fell inside the Central Coast region.-->
...
## Vancouver Island & Mainland Inlets {#vimi-region}
...
### Conservation Unit Changes {#vimi-cu-changes}
...
### Population Data and Analytical Methods {#vimi-pop-data}
...
#### Spawner Surveys {#vimi-spawner-surveys}
...
#### Juvenile Surveys {#vimi-juvenile-surveys}
...
#### Hatchery Releases {#vimi-hatchery-releases}
...
#### Spawner Abundance {#vimi-spawner-abundance}
...
#### Run Timing {#vimi-run-timing}
<!-- Steph to add detailed sources from paper when feasible. -->

Run timing data were compiled from a variety of sources detailed in @WilsonPeacockInprepTimingMajorFreshwater. See [Overview of Population Indicators: Run Timing](#run-timing) for a description of the run timing indicator and methods.

#### Catch & Run Size  {#vimi-catch-run-size}

**Catch and run size** data were provided for chum (Diana Dobson, DFO Stock Assessment), pink (Pieter van Will, DFO Stock Assessment), and sockeye (Diana Dobson and Pieter van Will, DFO Stock Assessment) in the Vancouver Island & Mainland Inlets Region. For a general description of catch and run size methods, see [Overview of Population Indicators: Catch & Run Size](#catch-run-size).

#### Recruits-per-Spawner {#vimi-recruits-per-spawner}
...
### Habitat Data and Analytical Methods  {#vimi-hab-data}
...
#### Trans-regional Conservation Units {#vimi-trans-cu}
...
#### Spawning Zones of Influence {#vimi-zoi}
...
#### Forest Disturbance on Southeast Vancouver Island {#vimi-forest-disturbance}
...
#### Additional Spawning Habitat Information Sources {#vimi-expert-knowledge}
