...
To address this limitation, watershed areas were evaluated across the Yukon region and ranked by size. Watersheds within the smallest 3% by area—identified using a clear inflection point in the area distribution—were classified as non-representative units and assigned a threat status of Data Deficient.

#### Spawning Zones of Influence

Methods for delineating spawning zones of influence (ZOIs) vary by region in accordance with the CU delineation approach used by DFO. For the Yukon, spawning ZOIs for each species CU were delineated using the extent of all MERIT-Basins Assessment Watersheds that directly intersected with the CU boundaries of that species.
