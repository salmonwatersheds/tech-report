...
Spawning habitat information for the Yukon was acquired directly from the Fish Information Summary System (FISS) Yukon data custodian and also through collaborations with representatives from <!-- Katy to populate list Yukon groups --> and independent salmon experts to identify local salmon spawning locations. Efforts to expand this information will continue, to ensure that our assessments reflect the known extent of spawning habitats throughout the Yukon.
