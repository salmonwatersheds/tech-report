...
For all spawning location information, we assign spawning locations to individual CUs. <!-- BSC: confusing sentence, suggestion: "The spawning location data serves to assign spawning location to individual CUs." --> For all species except lake-type sockeye, we assign a spawning location to a CU when it is located within that CU. This is done on a species-specific basis, except for pink CUs. If spawning location data sources did not differentiate between even-year or odd-year pink, we attributed that spawning location to both even-year and odd-year pink CUs in that area (where applicable). For lake-type sockeye, CU boundaries tend to be constrained to a rearing lake. We use the rearing lake zone of influence to capture the side channels where salmon spawn. Sockeye spawning locations situated outside the lake-type sockeye spawning zone of influence are assigned to the river-type sockeye CUs that encompass them. 
...
We developed this set of habitat pressure indicators during our initial methodology development with the Skeena Technical Advisory Committee [@Porter2013a; @Porter2014], building off the recommendations for monitoring and evaluation of salmon habitats under the Wild Salmon Policy [@Stalberg2009], and incorporating additional pressure indicators proposed by **Nelitz (2007)**. Some of these same indicators have been used in other habitat assessment work in the Fraser River watershed [@Nelitz2011] and on the west coast of Vancouver Island [e.g. @Smith2016; @Wright2011]. We apply specific inclusion criteria to select the datasets we use to inform these habitat pressure indicators, ensuring the standardization of methodologies across Regions. The data that we include must be:
