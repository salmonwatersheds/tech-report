...
knitr::include_graphics("figures/regions_YK.png")
```


## Yukon Region {#yukon-region}

```{r ykMap, fig.cap = "Map of the Yukon Region.", include=TRUE, echo = FALSE, out.width='70%', fig.align='center', fig.alt=''}
knitr::include_graphics("figures/yukon_map.png")
```
