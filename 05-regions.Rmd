...
**Observed spawner abundance** for CUs in the Central Coast Region is the sum of all spawner survey data documented in NuSEDS, as described in [Overview of Population Indicators: Spawner Abundance](#spawner-abundance). Similar to our work in the Skeena and Nass, we accessed most of these datasets via the North and Central Coast (NCC) database, maintained by LGL Ltd. [@EnglishEtAl2018NorthCentralCoast].
...
**Trends in spawner abundance** were derived for pink, Chinook, and sockeye from the estimated spawner abundance data provided by the Pacific Salmon Commission (Fiona Martens), @BrownEtAl20202020SummaryAbundance, and DFO (Tracy Cone, DFO Stock Assessment, Sockeye & Pink Analytical Program) respectively. For a description of trends in spawner abundance methods, see [Overview of Population Indicators: Trends in Spawner Abundance](#spawner-abundance).
