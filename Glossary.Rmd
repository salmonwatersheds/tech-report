...
128
stream. Indicator streams are those that have been identified in some Regions 
...
conditions develop over time. These adaptations have been linked to distinct lifehistory strategies in order to maximize fitness over time. 
...
sum of escapement, all fisheries catches, and estimated pre-spawn and postrelease mortality. 
...
129
abundance) and those that are caught or intercepted on route to the spawning 
