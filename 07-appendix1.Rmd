...
Conversation Units (CUs) listed by region and species (click header to sort). The CU names are as appearing in the Pacific Salmon Explorer. The CUID is assigned by PSF to track CUs that we recognize, as these are not always the same as official CUs recognized by DFO (see Regions for details). The Full CU Index is based on @holtby2007 and is used to cross-reference against NuSEDS and other DFO datasets.
