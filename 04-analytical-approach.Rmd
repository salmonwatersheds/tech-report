...
Our assessment methodology uses the concept of a **zone of influence (ZOI)** to identify the area of land considered to influence freshwater salmon habitat. Using ZOIs to assess salmon freshwater habitats aligns with Strategy 2 of the Wild Salmon Policy, in that 1) the identification of habitats that support or limit salmon production is necessary to inform assessment, monitoring, and protection priorities; and 2) habitat requirements vary by species, life history characteristics and phase, and geography [@DFO2005CanadaPolicyConservation].
