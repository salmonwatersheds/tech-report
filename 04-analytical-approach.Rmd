...
This criterion indicates the quality of the juvenile survey data over the most recent generation based on method type and execution.

| Score               | Definition                                                                                                                                                               |
|:-------------|:---------------------------------------------------------|
| NA - Not applicable | A Not Applicable score indicates that no juvenile surveys were completed for this Conservation Unit over the most recent generation.                                     |
| 1 - Low             | A Low score indicates that most of the juvenile surveys were performed with low-effort or inconsistently executed methods, resulting in variable accuracy and precision. |
| 2 - Medium-Low      | A Medium-Low score indicates that most of the juvenile surveys were performed with medium to low effort.                                                                 |
| 3 - Medium          | A Medium score indicates that most of the juvenile surveys were performed with medium effort.                                                                            |
| 4 - Medium-High     | A Medium-High score indicates that most of the juvenile surveys were performed with high effort.                                                                         |
| 5 - High            | A High score indicates that most of the juvenile surveys produce counts of total juveniles.                                                                              |
