# Appendix 4: Biological Status Details {#appendix-4 .unnumbered}
...
<!-- and the province of BC (applicable to steelhead only) -->
...
app4 <- read.csv("tables/appendix4.csv", na.strings = NA)

# ***Remove Yukon and Transboundary for now ***
app4 <- app4[which(app4$Region %in% c("Yukon", "Transboundary") == FALSE), ]
...
reactable::reactable(
	...
	columnGroups = list(
		...
		colGroup(
			...
			columns = c("Percentile", "Probability.of.Red.Status", "Probability.of.Amber.Status", "Probability.of.Green.Status", "WSP", "COSEWIC") #, "Province")
		),
		colGroup(
