...
The Sakinaw sockeye CU was declared extinct in the wild by DFO as of 2009 [@fisheriesandoceanscanadadfo2017FraserSockeye2018]. However, there is still a population from a captive broodstock program maintaining a hatchery-derived population in Sakinaw Lake. However, since this CU was immediately reintroduced from broodstock from the same CU, it does not meet the criteria for being declared de novo [@Wade2019].
