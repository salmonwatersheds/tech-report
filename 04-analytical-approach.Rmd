...
Through engagement with an expert Habitat Science Advisory Group (HSAC) we have identified a set of seven “core” pressure indicators affecting salmon habitats that are to be assessed and visualized within the Pacific Salmon Explorer. These selected core habitat pressure indicators include:  forest harvest, fire disturbance, insect disturbance, agriculture, urban and industrial development, roads, and mines. The intent of these core pressure indicators is that in composite they represent the primary suite of broad-scale land disturbances directing or indirectly impacting freshwater habitats. For each of these core pressure indicators we have defined defensible literature-defined empirically-based “hazard” benchmark values that can be applied across provincial watersheds for ascribing the relative level of concern (i.e., low, medium, high) in regards to their potential degradation of salmon habitats.
...
Overall, temporal and spatial data gaps limit our ability to quantify and assess current freshwater salmon habitat risks accurately. Better and more current spatial data are needed to support a more accurate and up-to-date assessment of pressures on freshwater salmon habitats across all Regions<!-- (see [Appendix 6](#appendix-6) for dataset limitations)-->.
